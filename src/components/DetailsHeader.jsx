    ...
    <div className="relative w-full flex flex-col mb-5">
      ...
      <div className="absolute inset-0 flex items-center">
        <img 
         ...
         className="sm:w-48 w-28 sm:h-48 h-28 rounded-full object-hover border-2 shadow-xl shadow-black" 
        />
        <div className="ml-5">
          <p className="font-bold sm:text-4xl text-xl text-white">{artistId?artistData?.artists[artistId].attributes.name:songData?.title}</p>
          {
            !artistId&&(
